...
class gerritbot(
  ...
  if $password != undefined {
    warning("The password parameter to the ::gerritbot class is a noop. Please
    pass the parameter to the gerritbot::bot defined type.")
  }

  if $channel_file != undefined {
    warning("The channel_file parameter to the ::gerritbot class is a noop.
    Please pass the parameter to the gerritbot::bot defined type.")
  }

  if $server != undefined {
    warning("The server parameter to the ::gerritbot class is a noop. Please
    pass the parameter to the gerritbot::bot defined type.")
  }
  ...
  if $vhost_name != undefined {
    warning("The vhost_name parameter to the ::gerritbot class is a noop. Please
    pass the parameter to the gerritbot::bot defined type.")
  }
